...
const translations = {
  en: {
    ...
    voiceChatDesc: "Talk to this agent using your voice",
    voiceLabel: "Voice",
    voiceHint: "The voice used when the agent speaks back to you",
    voiceSpeedLabel: "Speaking Speed",
    voiceSpeedHint: "How fast the agent speaks",
    startVoice: "Start Voice",
    stopVoice: "Stop",
    voiceRecording: "Listening...",
    voiceTranscribing: "Transcribing...",
    voiceSpeaking: "Speaking...",
    voiceError: "Voice error — check microphone permissions",
    growth: "Growth",
    growthDesc: "How this agent's personality and backstory have evolved through conversation",
    growthEmpty: "No growth events yet",
    growthEmptyHint: "Have a meaningful conversation with this agent — as it learns and grows, changes will appear here.",
    growthField: "Field",
    growthFrom: "Before",
    growthTo: "After",
    growthApplied: "Applied",
    growthRevert: "Revert",
    growthReverting: "Reverting...",
    growthReverted: "Reverted",
    growthBackstory: "Backstory",
    growthPersonality: "Personality",
  },
  ar: {
    ...
    voiceChatDesc: "تحدث مع هذا العميل باستخدام صوتك",
    voiceLabel: "الصوت",
    voiceHint: "الصوت المستخدم عند رد العميل عليك",
    voiceSpeedLabel: "سرعة الكلام",
    voiceSpeedHint: "مدى سرعة حديث العميل",
    startVoice: "بدء الصوت",
    stopVoice: "إيقاف",
    voiceRecording: "يستمع...",
    voiceTranscribing: "تحويل الكلام...",
    voiceSpeaking: "يتحدث...",
    voiceError: "خطأ صوتي — تحقق من أذونات الميكروفون",
    growth: "النمو",
    growthDesc: "كيف تطورت شخصية هذا العميل وقصته من خلال المحادثات",
    growthEmpty: "لا توجد أحداث نمو بعد",
    growthEmptyHint: "أجرِ محادثة ذات معنى مع هذا العميل — عندما يتعلم وينمو، ستظهر التغييرات هنا.",
    growthField: "الحقل",
    growthFrom: "قبل",
    growthTo: "بعد",
    growthApplied: "طُبِّق في",
    growthRevert: "تراجع",
    growthReverting: "جاري التراجع...",
    growthReverted: "تمّ التراجع",
    growthBackstory: "القصة",
    growthPersonality: "الشخصية",
  }
};
