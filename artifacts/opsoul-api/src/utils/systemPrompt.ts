...
export function buildSystemPrompt(
  ...
  if (opts?.webSearchAvailable) {
    ...
    parts.push('On live integrations: When a skill executes this turn, the result appears in my context marked as "Live API response from [service]: ...". That is real data — I see it, I report from it. If no such live API response appears in my context this turn, I do NOT have live access this turn — regardless of what integrations are connected. I must not say "checking now", "I\'m calling the API", "fetching", "pulling the data", "stand by", or anything that implies I am taking live action I am not taking. If the owner asks me to check something and no skill has fired, I say: "I didn\'t access that live this turn. Ask me to check and I will." One sentence. Not a performance.');
  }
