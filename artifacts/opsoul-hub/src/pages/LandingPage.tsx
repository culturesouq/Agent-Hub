  ...
  return (
    <PublicLayout>
      <main className="relative z-10 bg-black text-white">
        {/* Dark NVIDIA-style aesthetic with cozy spacing: one flowing
            column, no hard section dividers, no grid borders. Generous
            whitespace, restrained accent use. */}

        <div className="max-w-5xl mx-auto px-6 md:px-10 lg:px-14 pt-36 pb-32">

          {/* ── Hero ─────────────────────────────────────────────────── */}
          <header>
            <div className="inline-flex items-center gap-2.5 mb-10 px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/30">
              <span className="block w-1.5 h-1.5 rounded-full bg-violet-400" />
              <span className="font-sans text-xs text-violet-300 tracking-wide">A new generation of agentic AI</span>
            </div>

            <h1 className="font-headline font-bold text-white text-5xl md:text-6xl lg:text-7xl leading-[1.05] tracking-tight mb-8">
              Agents are temporary.<br />
              <span className="text-violet-400">Operators are eternal.</span>
            </h1>

            <p className="font-sans text-lg md:text-xl text-white/70 max-w-2xl mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3 mb-24">
              <a
                href="/console"
                className="inline-flex items-center bg-violet-500 hover:bg-violet-400 text-black font-sans text-sm font-medium px-7 py-3 rounded-full transition-colors"
              >
                Request Access
              </a>
              <a
                href="/contact"
                className="inline-flex items-center text-white/80 hover:text-violet-400 font-sans text-sm font-medium px-7 py-3 transition-colors"
              >
                Get in touch →
              </a>
            </div>
          ...
          <section className="mb-24">
            <p className="font-sans text-lg md:text-xl text-white/75 leading-relaxed mb-6 max-w-3xl">
            ...
            <p className="font-sans text-lg md:text-xl text-white/75 leading-relaxed max-w-3xl">
          ...
          {/* ── Six qualities — quiet 3x2 grid, whitespace separators ─── */}
          <section className="mb-24">
            <h2 className="font-headline font-bold text-white text-3xl md:text-4xl leading-tight mb-12 max-w-2xl">
              What <span className="text-violet-400">eternal</span> means.
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              {[
                ...
                <div key={f.title}>
                  <h3 className="font-headline font-semibold text-white text-xl mb-2">
                    {f.title}
                  </h3>
          ...
          {/* ── Closing invitation — single soft divider ──────────────── */}
          <section className="border-t border-white/10 pt-16">
            <h2 className="font-headline font-bold text-white text-3xl md:text-5xl leading-tight tracking-tight mb-6 max-w-3xl">
              The first Operators are <span className="text-violet-400">already alive.</span>
            </h2>
            <p className="font-sans text-lg text-white/70 mb-10 max-w-2xl leading-relaxed">
