...
// NOTE — Earlier versions of this page hosted a "VAEL Desk" surface (Drop Zone,
// Pending Inbox, DNA Library, Sources, Verification Runs). That surface depended
// on `/admin/rag/*` backend routes that were never implemented in
// routes/admin.ts (SoT 2026-05-22 §890 marked all of it inert dead code).
// The interfaces, state, functions, and JSX were removed in Phase 2 (commit
// "feat(phase-2): admin — remove inert VAEL Desk"). If a SRAG-style surface is
// reintroduced (per [[srag-vael-as-service]]) it should be rebuilt fresh
// alongside its backend routes, not by reviving this dead shell.
